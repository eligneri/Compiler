...
/*
 * This class has a hard coded parse table, and returns the appropriate value given a token and a non token
 */
public class ParseTable
{
    ...
    private String[] TokenList = new String[]
            {
    ...
    private String[] StackList = new String[]
            {
    ...
    //this takes in a token and a stack symbol and returns the appropriate production
    public int GetValue(String token, String stack)
    {
        return Table[GetToken(token)][GetStack(stack)];
    }

    //this finds a the appropriate row in the parse table given a token
    private int GetToken(String in)
    {
        return Arrays.asList(TokenList).indexOf(in);
    }

    //this finds the appropriate column given a stack symbol
    private int GetStack(String in)
    {
        return Arrays.asList(StackList).indexOf(in);
    }
}
